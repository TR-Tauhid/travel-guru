                    ...
                    <div>
                        <form onSubmit={handleFormSubmit} >
                            ...
                            <div className="flex flex-col w-full mx-auto">
                                <input type="email" name="email" required placeholder="Username or Email" className="input mb-10 rounded-none input-ghost border-t-0 border-r-0 border-l-0 text-black font-montserrat-medium bg-white border-b-2 border-[#C5C5C5] focus:text-black focus-within:outline-none w-full" />
                                <input type="password" name="password" required placeholder="Password" className="input rounded-none input-ghost border-t-0 border-r-0 border-l-0 bg-white text-black font-montserrat-medium border-b-2 border-[#C5C5C5] focus:text-black focus-within:outline-none w-full" />
                            </div>
                            ...
                            <div>
                                <button type="submit" className="btn btn-primary bg-[#F9A51A] w-full rounded-none font-medium text-black text-base mt-14 h-16 hover:bg-red-500 hover:scale-110">Login</button>
                            </div>
                        </form>
                        ...
                        <div className="font-montserrat-medium space-y-4 mt-4 text-black">
                            <div onClick={handleFacebookBtn} className="rounded-full flex items-center border-2 border-[#ABABAB] ">
                            ...
                            <div onClick={handleGoogleBtn} className="rounded-full flex items-center border-2 border-[#ABABAB] ">
